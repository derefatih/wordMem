    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WordId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    OwnLang = table.Column<string>(nullable: true),
                    ForeignLang = table.Column<string>(nullable: true),
                    SampleSentence = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WordStatisticId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IsLearned = table.Column<bool>(nullable: false),
                    IsStudied = table.Column<bool>(nullable: false),
                    Asked = table.Column<int>(nullable: false),
                    Answered = table.Column<int>(nullable: false),
                    WordId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordStatics", x => x.WordStatisticId);
                    table.ForeignKey(
                        name: "FK_WordStatics_Words_WordId",
                        column: x => x.WordId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Compare = table.Column<bool>(nullable: false),
                    Fill = table.Column<bool>(nullable: false),
                    Random = table.Column<bool>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
